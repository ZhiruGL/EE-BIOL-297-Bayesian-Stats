...
```{r}
#The Law of Large Numbers seems to hold for means of non-normal distributions as well. One remarkable difference is that for the Gamma distribution, when sample sizes are small, the sample means are much higher than the population mean, whereas for the other two distributions, the sample means at low sample sizes fluctuate both above and below the population mean.
```
