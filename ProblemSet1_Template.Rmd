...
SD_Y=20 #Population standard deviation
...
```{r}
for (i in 2:500){
  Y=c(Y,rnorm(1,mean=E_Y,sd=SD_Y)) # Draw single value from the normal distribution and concatenate with the previous values of Y
  mean1[i]=mean(Y)
}
```
...
```{r}
plot(x=1:500,mean1,type="l",xlab="Sample size",ylab="Mean of sample",main="A Test of LLN with Normal Distribution (sd=20)")
...
plot(x=1:500,mean2,type="l",xlab="Sample size",ylab="Mean of sample", main="A Test of LLN with Normal Distribution (sd=50)")
abline(h=E_Y,col="red")
...
plot(x=1:500,mean3,type="l",xlab="Sample size",ylab="Mean of sample",main="A Test of LLN with Normal Distribution (sd=5)")
abline(h=E_Y,col="red")
...
```{r}
plot(1:500, mean1, type = "l", col = "red",ylim=c(160,270),xlab="Sample size",ylab="Mean of sample",main="A Test of LLN with Normal Distribution with variable sd") 
lines(1:500, mean2, col = "green")
lines(1:500, mean3, col = "blue")
abline(h=E_Y,col="black",lwd=2,lty=2)
legend("bottomright",legend = c("Population Mean","Standard Deviation = 5","Standard Deviation = 20", "Standard Deviation = 50"),col = c("black", "blue", "red", "green"),lty = c(2, 1, 1, 1),lwd = 1)
...
plot(x=1:500,mean_pois,type="l",xlab="Sample size",ylab="Mean of sample",main="A Test of LLN with Poisson Distribution")
abline(h=E_Y,col="red")
##############################################################################################
gamma_shape_Y=200 
gamma_scale_Y=1 
...
plot(x=1:500, mean_gamma,type="l",xlab="Sample size",ylab="Mean of sample",main="A Test of LLN with Gamma Distribution")
abline(h=E_Y,col="red")
```
