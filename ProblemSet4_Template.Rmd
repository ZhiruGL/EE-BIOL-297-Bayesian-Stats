...
#It helped as the Bayesian p-value is now 0.464, which is closer to 0.5 compared to the previous 0.547 when only 1 predictor was used. Acoording to the dot plot, the predictions are alos closer to the 1:1 line which also suggested a better fit.
```
